...
$faq = [
  ...
  [
    ...
    'contenuto' => "  <p> Sappiamo che la sicurezza e la privacy sono importanti per te e lo sono anche per noi. Per noi è imperativo offrire un'elevata sicurezza e assicurarti che le tue informazioni sono al sicuro e accessibili quando ne hai bisogno.  </p>
  ...
  [
    ...
    'contenuto' => " <p> Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose:  </p>
...
<div class="fc-container">
  ...
  <?php  for($i=0; $i<count($faq); $i++){ ?>
    ...
    <h2> <?php echo $faq[$i]['titolo']?> </h2> 
    <p>  <?php echo $faq[$i]['contenuto']?></p>
